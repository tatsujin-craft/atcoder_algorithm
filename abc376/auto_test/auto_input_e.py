#!/usr/bin/env python3
"""
Script Name: auto_input_e.py
Description: 
    This script runs Python script or C++ program with automatic input data.

Usage:
    $ ./auto_input_e.py          # Runs the main Python script
    $ ./auto_input_e.py --prac   # Runs the practice Python script
    $ ./auto_input_e.py --cpp    # Compiles and runs the C++ program
