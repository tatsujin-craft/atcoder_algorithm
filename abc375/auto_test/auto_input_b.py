#!/usr/bin/env python3
"""
Script Name: auto_input_b.py
Description: 
    This script runs Python script or C++ program with automatic input data.

Usage:
    $ ./auto_input_b.py          # Runs the main Python script
    $ ./auto_input_b.py --prac   # Runs the practice Python script
    $ ./auto_input_b.py --cpp    # Compiles and runs the C++ program
